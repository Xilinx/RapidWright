...
/**
 * A collection of data modified during routing. Each RoutableData is associated with a unique Routable
 */
public class RoutableData {
	/** A unique index of this RoutableData, same as the corresponding Routable (RoutableNode, or rnode) */
	...
	/** A set of the sources of nets that are using the rnode */
	private HashMultiset<SitePinInst> sourceSet;
	/** A set of drivers (parents) of the rnode */
	...
	/**
	 * Counts the total number of a source included in the source set, which equals to the number of connections driven by the source that are using the rnode 
	 * @param source The source SitePinInst
