...
public interface Routable {
	 ...
	 */
	void updatePresentCongestionCost(float presentCongestionFactor);
	/**
	 ...
	 */
	boolean isInConnectionBoundingBox(Connection connection);
	/**
	 ...
	 */
	Map<NetWrapper, Integer> getUsersConnectionCounts();
	 ...
	 */
	void incrementUser(NetWrapper user);
	 ...
	 */
	void decrementUser(NetWrapper user);
